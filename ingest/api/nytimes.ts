import { nyt_api_topstories_document } from '../../models/ts/nytimes/NYTimesApiTopStoriesDocument';
 ...
 *
 */
export async function getNYTimesTopStories(): Promise<Array<nyt_api_topstories_document>> {
    ...
    return resJson.results as Array<nyt_api_topstories_document>;
}
 ...
 * @param topStory
 */
export function mapNYTimesTopStoryToArticle(topStory: nyt_api_topstories_document) {
    return  {
